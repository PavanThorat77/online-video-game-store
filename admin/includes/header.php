...
<head>
    ...
    <title>GameStore Management System - Admin Panel</title>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">GameStore Management System</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default navbar-static-side" role="navigation">
                <div class="sidebar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="#"><i class="fa fa-bar-chart-o fa-fw"></i> Game<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="book_add.php">Add Game</a>
                                </li>
                                <li>
                                    <a href="book_view.php">View Game</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li>
